...
import lda.med_slda.MedSLDA;
import util.IOUtil;

public class CmdSLDA
{
	public static void main(String args[]) throws IOException, ParseException
	{
		...
		LDAParam param=new LDAParam(cmd.getOptionValue("v"));
		if (cmd.hasOption("a"))
		{
		...
		else//test
		{
			if (!cmd.hasOption("hl"))//mse
			{
				slda=new SLDA(cmd.getOptionValue("m"), param);
			}
			else//hinge
			{
				slda=new MedSLDA(cmd.getOptionValue("m"), param);
			}
			slda.readCorpus(cmd.getOptionValue("d"));
